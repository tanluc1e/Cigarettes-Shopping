        ...
        <header>
          <div className={cx("image-text")}>
            ...
            <div className={cx("text logo-text")}>
              <span className={cx("name")}>Cửa hàng</span>
              <span className={cx("profession")}>Quản Lý</span>
            </div>
            <MdOutlineKeyboardArrowRight
              size={12}
              className={cx("toggle")}
        ...
        <div className={cx("menu-bar")}>
            ...
            <ul className={cx("menu-links")}>
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Thống kê".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Sản phẩm".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Danh mục".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Thương hiệu".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Đơn hàng".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Tin tức".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Khuyến mãi".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Đánh giá".toLowerCase().includes(search.toLowerCase()),
                })}
              >
              ...
              <li
                className={cx("nav-link", {
                  "d-none":
                    search &&
                    !"Tài khoản".toLowerCase().includes(search.toLowerCase()),
                })}
              >
          ...
          <div className={cx("bottom-content")}>
            <li className={cx("mode")}>
              ...
              <span className={cx("mode-text text")}>
