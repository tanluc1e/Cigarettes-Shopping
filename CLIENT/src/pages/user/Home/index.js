  ...
  const renderCategories = () => {
    ...
    if (categories.length === 0) {
      if (preload) {
        ...
        return (
          <div className="w-100 mt-5 text-center">Lỗi bất định thử lại sau</div>
        );
      }
    }
  };
      ...
      if (loading) {
        ...
        return (
          <div className="w-100 mt-5 text-center">
            No article was found. Please try again
          </div>
        );
      }
    }
    ...
    <>
      <div className="container page-content">
        <div className="row">
          ...
          <div className="col col-xl-4 d-none d-sm-none d-md-none d-lg-none d-xl-block">
            <div className="policy-list">
              <div className="policy-item">
                <p>Bảo hành tận tâm</p>
                <span>
                  Chúng mình luôn cam kết sẽ hỗ trợ khách hàng mọi vấn đề.
                </span>
              </div>
            </div>
          </div>
        ...
        /> */}
        <h5 style={{ fontWeight: "700", marginBottom: "0", marginTop: "8px" }}>
          CÁC SẢN PHẨM
        </h5>
        <div className="category-home">
          <BrandCarousel />
        </div>
        <ProductCarousel title="Thuốc Lá" />
        <ProductCarousel title="Cigar" />
        <ProductCarousel title="Zippo" />
          ...
          <MDBModalDialog>
            ...
            >
              <MDBModalBody style={{ padding: "24px 18px" }}>
                <h5>Chào mừng đến với Cửa hàng Thuốc Lá</h5>
                <br />
                <p>
                  ● Chúng tôi tự hào mang đến cho bạn những sản phẩm thuốc lá
                  chất lượng và đa dạng, đảm bảo đáp ứng mọi nhu cầu và sở thích
                  của bạn. Với sự đa dạng về hương vị, hy vọng bạn sẽ tìm thấy
                  những sản phẩm ưng ý nhất.
                </p>
                <br />
                <p>
                  ● Nếu bạn cần bất kỳ hỗ trợ hay thông tin nào, hãy liên hệ với
                  chúng tôi. Chúng tôi luôn sẵn lòng giúp đỡ bạn.
                </p>
                <br />
                <p>
                  ● Chúc bạn có một trải nghiệm mua sắm vui vẻ tại cửa hàng
                  thuốc lá của chúng tôi!
                </p>
                <br />
              </MDBModalBody>
            </MDBModalContent>
